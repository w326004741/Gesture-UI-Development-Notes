...
namespace InClassCortana
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                ...
                try
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("succcessfully loaded VCD....");

                }
                catch (Exception err)
                {
                    System.Diagnostics.Debug.WriteLine("Faild to load Page -"  + err.Message);
                }
            }
        }
        ...
        /// allows you to take control when voice activated  这里有改动
        /// </summary>>
